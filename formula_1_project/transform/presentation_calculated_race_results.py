...
spark.sql(f"""
              ...
              SELECT races.race_year,
                ...
                FROM formula1_gold.results 
                JOIN formula1_gold.drivers ON (results.driver_id = drivers.driver_id)
                JOIN formula1_gold.constructors ON (results.constructor_id = constructors.constructor_id)
                JOIN formula1_gold.races ON (results.race_id = races.race_id)
